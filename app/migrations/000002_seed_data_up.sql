...
-- UPDATED: Phase 5 - Bcrypt cost 12 (SR-001)
-- ============================================

-- Insert default admin and staff users
-- Password for all users: admin123 (bcrypt cost 12)
INSERT INTO users (email, name, role, password_hash) VALUES
('admin@checkthebox.local', 'Admin User', 'admin', '$2a$12$zdXLX4d2VM6qq.9FBzSPL.2v3isqN39K4rG5jmrKHn79R4MRHmChK'),
('staff1@checkthebox.local', 'John Doe', 'staff', '$2a$12$zdXLX4d2VM6qq.9FBzSPL.2v3isqN39K4rG5jmrKHn79R4MRHmChK'),
('staff2@checkthebox.local', 'Jane Smith', 'staff', '$2a$12$zdXLX4d2VM6qq.9FBzSPL.2v3isqN39K4rG5jmrKHn79R4MRHmChK')
